...
vim.api.nvim_set_keymap("n", "<C-s>", "<cmd>Gitsigns next_hunk<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<C-a>", "<cmd>Gitsigns prev_hunk<CR>", { noremap = true, silent = true })
