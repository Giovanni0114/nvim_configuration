...
vim.keymap.set("n", "<leader>gb", "<cmd>lua require('gitsigns').blame_line()<CR>", { desc = "Show blame" })

vim.keymap.set("n", "<leader>bt", "<cmd>BlameToggle virtual<CR>", { desc = "Git Blame Toggle (virtual)" })
